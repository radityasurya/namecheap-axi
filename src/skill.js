...
/**
 * Single source of truth for skills/namecheap-axi/SKILL.md.
 *
...
\`\`\`sh
npx -y ${BIN}                                  # dashboard: domains, expiry, what needs renewing
npx -y ${BIN} domains list --expiring 30
npx -y ${BIN} domains check example.dev other.io
npx -y ${BIN} domains info example.com
npx -y ${BIN} domains lock example.com         # idempotent
npx -y ${BIN} dns list example.com
npx -y ${BIN} dns set example.com www A 203.0.113.10
npx -y ${BIN} dns set example.com @ MX mx.example.net --priority 10
npx -y ${BIN} dns delete example.com old --type A
npx -y ${BIN} nameservers example.com
npx -y ${BIN} nameservers set example.com ada.ns.cloudflare.com bob.ns.cloudflare.com
\`\`\`
